package ru.molchanov.springcourse.config.DAO;
...
import ru.molchanov.springcourse.config.models.Person;
...
public class PersonDAO {
    ...
    public void save(Person person) {
        jdbcTemplate.update("INSERT INTO Person(name, age, email, addres) VALUES (?, ?, ?, ?)", person.getName(), person.getAge(),
    ...
    private List<Person> create100People() {
        ...
        for (int i = 0; i < 1000; i++)
            people.add(new Person(i, "Name" + i, 30, "test"+ i + "mail.ru" + i + "@mail.ru", "some address"));
        return people;
    }
